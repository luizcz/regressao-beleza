---
title: "Regressão linear sobre professores"
...
```{r}
dados%>%
    select(-cls_perc_eval, -cls_did_eval, -cls_profs, -cls_credits, -cls_students, -bty_f1lower, -bty_f2upper, -bty_f1upper,-bty_m1lower, -bty_m2upper, -bty_m1upper  )%>%
    ggpairs()
dados %>%
